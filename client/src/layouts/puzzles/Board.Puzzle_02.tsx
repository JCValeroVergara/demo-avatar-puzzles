...
import { BoxContainer_Puzzle_03, ButtonAssistant, CardPuzzle_World_03 } from "../../components";
    ...
    const handleStartGame = () => {
        ...
        return (
                <div className="flex flex-col flex-wrap w-[97vw] items-center justify-center">
                    <div className=" absolute top-0 w-full h-[10vh] flex flex-row justify-end">
                    <div className="w-full flex flex-row justify-center items-center transform -translate-x-[24vw] translate-y-[7vh]">
                        <h1 className=" w-full h-[4vh] text-[4vh] font-bold text-center text-textos">
                        Desafío de La Escuela de la Vida
                        </h1>
                    </div>
                    </div>
                    <div className="w-full h-full pt-[10vh] px-[1.5vw] pb-[1.5vw]">
                        <div className="w-[70vw] h-full flex flex-row items-center p-[1.25vw]">
                        <div className="ml-[6vw] w-[32vw] h-[56vh] transform -translate-y-[5.2vh] px-[0.6vw]">
                        ...
                        <div className="w-[30vw] h-[65vh] flex flex-col items-end justify-end transform -translate-y-[4vh] translate-x-[1.2vw]">
